...
impl EdgeShapeEmitter {
    ...
    pub fn create(shape: &crate::iparticle_system_config::IShapeEdge) -> TypeShapeEmitter {
    ...
    pub fn start_direction_function<'a>(
        ...
        direction_to_update.y = 1.;
        direction_to_update.z = 0.;
    ...
    pub fn start_position_function<'a>(
        ...
        let size = shape.param[Self::IDX_SIZE];
        ...
        let mut rand_x = size * (s / arc_value * 2. - 1.);
        let mut rand_y = 0.;
        let mut rand_z = 0.;
    ...
    pub fn serialize(&self) -> SerializationObject {
        SerializationObject {
            _type: Some(String::from("EdgeShapeEmitter")),
            radius: None,
            angle: None,
