...
impl TNodeMaterialBlock for NMBlockReflection {
    ...
    const BIND_DEFINES: pi_scene_shell::prelude::BindDefine = pi_scene_shell::prelude::BindDefines::ENVIRONMENT_LIGHTING;
    fn depends() -> Vec<pi_scene_shell::prelude::Atom> {
        vec![
            pi_scene_shell::prelude::Atom::from(BlockColorSpace::KEY)
        ]
    }
}