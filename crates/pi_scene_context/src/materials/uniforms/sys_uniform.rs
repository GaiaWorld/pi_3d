...
pub enum OpsUniformByName {
    Mat4(ObjectID, String, pi_scene_math::Matrix, bool),
    Mat2(ObjectID, String, pi_scene_math::Matrix2, bool),
    Vec4(ObjectID, String, pi_scene_math::Vector4, bool),
    Vec2(ObjectID, String, pi_scene_math::Vector2, bool),
    Float(ObjectID, String, pi_scene_math::Number, bool),
    Int(ObjectID, String, i32, bool),
    Uint(ObjectID, String, u32, bool),
