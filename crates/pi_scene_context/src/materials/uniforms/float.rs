...
impl FromValueUniformStatistics for FloatUniform {
    fn new(value: &ShaderBindEffectValue) -> Self {
        let slot = value.float_count.min(MAX / Self::N as u8);
        Self {
            slot,
            data: [0.; MAX as usize],
            begin: value.float_begin,
        }
    }
}
impl FloatUniform {
...
//         }
//     }
//     // pub fn value_mut(&mut self, slot: usize) -> Option<&mut [f32]> {
...
//     //         Self::Slot13(_, data) => Some(&mut data[range]),
//     //         Self::Slot14(_, data) => Some(&mut data[range]),
//     //         Self::Slot15(_, data) => Some(&mut data[range]),
//     //         Self::Slot16(_, data) => Some(&mut data[range]),
//     //     }
//     // }
//     pub fn set(
//         &mut self,
