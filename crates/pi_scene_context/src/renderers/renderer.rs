...
pub struct RendererParam {
    pub enable: RendererEnable,
    pub rendersize: RenderSize,
    pub colorformat: RenderColorFormat,
    pub color_clear: RenderColorClear,
    pub depthstencilformat: RenderDepthFormat,
    pub depth_clear: RenderDepthClear,
    pub stencil_clear: RenderStencilClear,
    pub auto_clear_color: RenderAutoClearColor,
    pub auto_clear_depth: RenderAutoClearDepth,
    pub auto_clear_stencil: RenderAutoClearStencil,
...
impl RendererParam {
    pub fn new(transparent: bool) -> Self {
        Self {
            enable: RendererEnable(true),
            rendersize: RenderSize::default(),
            colorformat: RenderColorFormat::default(),
            color_clear: RenderColorClear::default(),
            depthstencilformat: RenderDepthFormat::default(),
            depth_clear: RenderDepthClear::default(),
            stencil_clear: RenderStencilClear::default(),
            auto_clear_color: RenderAutoClearColor::default(),
            auto_clear_depth: RenderAutoClearDepth::default(),
            auto_clear_stencil: RenderAutoClearStencil::default(),
