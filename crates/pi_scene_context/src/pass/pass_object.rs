    ...
    pub fn can_batch_instance_memory(&self, other: &Self, debug: bool, max_combine_bytes: usize) -> bool {
            ...
            && self.bindgroupshash == other.bindgroupshash
        {
            match (&self.instance_memory, &other.instance_memory) {
                (Some(ins1), Some(ins2)) => {
                    // log::warn!("can_batch_instance_memory {:?}", (ins1.data.len() + ins2.data.len(), max_combine_bytes));
...
impl Default for PassRendererID {
    fn default() -> Self {
        Self(Entity::from_bits(0))
    }
}
...
impl Default for PassSceneForSet3 {
    fn default() -> Self {
        Self(Entity::from_bits(0))
    }
}
...
impl Default for PassMaterialID {
    fn default() -> Self {
        Self(Entity::from_bits(0))
    }
}
...
impl Default for PassGeometryID {
    fn default() -> Self {
        Self(Entity::from_bits(0))
    }
}
...
impl Default for PassIDs {
    fn default() -> Self {
        Self([Entity::from_bits(0),Entity::from_bits(0), Entity::from_bits(0), Entity::from_bits(0)
        ,Entity::from_bits(0),Entity::from_bits(0), Entity::from_bits(0), Entity::from_bits(0)])
    }
}
