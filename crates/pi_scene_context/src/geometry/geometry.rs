use render_data_container::TRenderGeometry;
use render_geometry::{vertex_data::TVertexBufferDesc, indices::{IndicesBufferDesc, AssetResBufferIndices}};

use super::vertex_buffer_useinfo::{AssetResVBSlot1, AssetDescVBSlot1, TVertexBufferUseInfo, TAssetResVertexBuffer, AssetResVBSlot2, AssetResVBSlot3, AssetResVBSlot4, AssetDescVBSlot2, AssetDescVBSlot3, AssetDescVBSlot4};
