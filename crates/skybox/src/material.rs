use pi_render::rhi::{dyn_uniform_buffer::{BindOffset, Bind, Uniform}, internal::bytemuck};

use pi_scene_context::{resources::RenderDynUniformBuffer, shaders::FragmentUniformBind, bytes_write_to_memory, materials::material::MaterialID};
