...
impl OpsMainTexTilloff {
    pub fn _ops(mat: Entity, uscale: f32, vscale: f32, uoffset: f32, voffset: f32) -> Self {
...
impl OpsAlpha {
    pub fn _ops(mat: Entity, val: f32) -> Self {
        Self(mat, val)
    }
}
...
impl OpsMainColor {
    pub fn _ops(mat: Entity, r: f32, g: f32, b: f32) -> Self {
        Self(mat, r, g, b)
    }
}
