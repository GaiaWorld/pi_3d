...
use pi_scene_context::{pass::pi_world::editor::EntityEditor, prelude::{TypeAnimeAssetMgrs, TypeAnimeContexts}};
...
use pi_winit::{event::{Event, WindowEvent}, event_loop::ControlFlow};
...
pub fn main() {
    ...
    app.add_plugins(pi_pbr::PluginPBR);
