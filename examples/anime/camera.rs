...
use pi_scene_context::pass::pi_world::editor::{self, EntityEditor};
...
fn setup(
    ...
    let root = editor.alloc_entity(); actions.transform.tree.push(OpsTransformNodeParent::ops(root, scene));
...
pub fn main() {
    ...
    // app.add_startup_system(Update, base::setup_default_mat);
