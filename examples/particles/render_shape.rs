...
fn cone_cfg(count: f32, _speed: f32) -> IParticleSystemConfig {
    ...
    cfg.start_speed = OneParamInfo::TInterpolateConstant(1.);
    cfg.start_color = FourGradientInfo::TInterpolateColor([1., 1., 1., 1.]);
    cfg.start_size = ParamInfo::OneParamInfo(OneParamInfo::TInterpolateConstant(0.4));
    ...
    cfg.scaling_mode = EMeshParticleScaleMode::Shape;
    ...
    cfg.shape = IShape::ShapeCone(IShapeCone {
        ...
        arc: IShapeArc::IShapeArcRandom(IShapeArcRandom { mode: EShapeEmitterArcMode::Random, value: 270.0, spread: 0., speed: 0. }),
