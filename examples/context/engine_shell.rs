...
use crate::shell_node::ScreenClearNode;
...
pub fn create_engine<T: Plugin>(win: &Arc<Window>, _r: f64, test: T) -> EnginShell {
    ...
    let _ = runtime.spawn(runtime.alloc(), async move {
        ...
        // 建立System运行队列
        PluginBundleDefault.init(&mut world, &mut engine, &mut runstages);
        test.init(&mut world, &mut engine, &mut runstages);
