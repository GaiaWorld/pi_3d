...
use pi_scene_context::{pass::pi_world::editor::EntityEditor, prelude::*};
use pi_slotmap::Key;
pub fn main() {}
...
impl PluginImageCopy {
    pub fn toscreen(
        ...
        // {
            let copymat = editor.alloc_entity();
            ...
            let plane = editor.alloc_entity(); actions.transform.tree.push(OpsTransformNodeParent::ops(plane, scene));
            ...
            let copycamera = editor.alloc_entity(); actions.transform.tree.push(OpsTransformNodeParent::ops(copycamera, scene));
            ...
            let copy_renderer = editor.alloc_entity(); actions.renderer.create.push(OpsRendererCreate::ops(copy_renderer, String::from("ImageCopy") + copy_renderer.data().as_ffi().to_string().as_str(), copycamera, PassTag::PASS_TAG_01, false));
