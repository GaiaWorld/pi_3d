...
fn setup(
    ...
    ActionMaterial::regist_material_meta(&matcmds.3, &mut matcmds.4, KeyShaderMeta::from(EmissiveFresnelShader::KEY), EmissiveFresnelShader::meta());
    ...
    matcmds.1.push(OpsMaterialCreate::ops(idmat, EmissiveFresnelShader::KEY, EPassTag::Transparent));
    matcmds.2.push(
