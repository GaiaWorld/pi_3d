...
fn setup(
    ...
    ActionMaterial::regist_material_meta(&matcmds.metas, &mut matcmds.metas_wait, KeyShaderMeta::from(MainOpacityFresnelShader::KEY), MainOpacityFresnelShader::create(&nodematblocks));
    ...
    matcmds.create.push(OpsMaterialCreate::ops(idmat, MainOpacityFresnelShader::KEY, EPassTag::Transparent));
