...
use pi_node_materials::{prelude::*, PluginNodeMaterial};
...
fn setup(
    ...
    ActionMaterial::regist_material_meta(&matcmds.3, &mut matcmds.4, KeyShaderMeta::from(MainOpacityShader::KEY), MainOpacityShader::meta());
    ...
    matcmds.1.push(OpsMaterialCreate::ops(idmat, MainOpacityShader::KEY, EPassTag::Transparent));
